...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.nameLabel.setText('Введите формулу')
        self.line = QLineEdit(self)

        # print label
        self.nameLabel_4 = QLabel(self)
        self.nameLabel_4.setText('Результат')
        ...
        pushbutton = QPushButton('Посчитать', self)
    ...
    def clickMethod(self,):
        ...
        q = str(text1)
        b = moll_mass(q)
        self.nameLabel_4.setText('Результат: ' + 'Формула: ' + str(q) + '\n' +
                                 'Молекулярная масса: ' + str(q) + ' = ' + str(b) + ' г/моль')
